      ...
      <section className="py-16 sm:py-20 bg-brand-charcoal text-white relative overflow-hidden">
        <Container>
          <div data-reveal="group" className="max-w-3xl space-y-4">
            <div
              data-reveal="eyebrow"
              className="inline-flex items-center gap-2 rounded-full border border-brand-amber/40 bg-brand-amber/10 px-3.5 py-1.5 text-xs font-bold uppercase tracking-wider text-brand-amber"
            >
