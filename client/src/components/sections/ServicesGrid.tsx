...
const SOLUTIONS = [
  {
    ...
    title: "Solar designed for better living.",
    description:
      "Generate your own electricity with a professionally engineered rooftop solar system for your home.",
    image: stock1Img,
    ctaText: "Plan My Home Solar",
  },
  {
    id: "commercial",
    number: "02",
    ...
    description:
      "Turn available commercial rooftop space into a reliable solar asset designed around energy requirements, system performance and long-term returns.",
    image: stock2Img,
  ...
  },
  {
    ...
    title: "Solar engineered for industry.",
    description:
      "High-capacity solar solutions for factories, warehouses and manufacturing facilities, engineered for performance, reliability and long-term operation.",
    image: heroBgImg,
    ctaText: "Plan My Industrial Solar",
  },
  {
    id: "institutional",
    number: "04",
    ...
    icon: Landmark,
    href: "/contact",
    title: "Reliable solar for institutions.",
    description:
      "Engineered solar solutions for educational, healthcare and institutional facilities, designed around energy requirements, available space and long-term performance.",
    image: skyImg,
    ctaText: "Plan My Institutional Solar",
  },
];
