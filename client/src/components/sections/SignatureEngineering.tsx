  ...
  return (
    <section className="relative py-20 lg:py-28 bg-[#0C3046] text-white overflow-hidden border-b border-slate-800">
      ...
      <Container className="relative z-10">
        <div data-reveal="group" className="max-w-4xl mx-auto text-center space-y-6">
          <div
            data-reveal="eyebrow"
          ...
          <h2
            data-reveal="heading"
            className="font-heading text-4xl sm:text-6xl lg:text-7xl font-extrabold tracking-tight text-white uppercase leading-[1.05]"
          >
            Engineering <br />
          ...
          <p
            ...
            className="text-slate-300 text-base sm:text-xl lg:text-2xl max-w-3xl mx-auto font-light leading-relaxed"
          >
